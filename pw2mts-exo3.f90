...
!!$  CALL Compute_LocalStiffness_Matrix_And_LocalRHS(mesh,889,AL,RHSL)
!!$  print*, 'AL= ', AL
!!$  print*, 'RHSL= ', RHSL
  NT=mesh%nbTriangles
...
!!$  print*, 'IND(1:5,1:3)= ', IND(1:5,1:3)
!!$  print*
!!$  print*, 'VAL(1:5,1:3)= ', VAL(1:5,1:3)
!!$  print*
!!$  print*, 'NBE(1:5)= ', NBE(1:5)
!!$  print*
!!$  print*, 'RHS(1:5)= ', RHS(1:5)
...
!!$  print*, 'NNE= ', NNE ; print*
!!$  print*, 'A(1:10)= ', A(1:10) ; print*
!!$  print*, 'JA(1:10)= ', JA(1:10) ; print*
!!$  print*, 'IA(1:10)= ', IA(1:10) ; print*
...
!ccccccccccccccccccccccccccccccc
  ...
  CALL Boundary_Conditions(mesh,IA,JA,A,RHS)
!!$  print*, 'IA(1:5)= ', IA(1:5) ; print*
!!$  print*, 'JA(1:5)= ', JA(1:5) ; print*
!!$  print*, 'A(1:5)= ', A(1:5) ; print*
!!$  print*, 'RHS(1:5)= ', RHS(1:5) ; print*
